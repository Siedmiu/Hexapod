...
def generate_launch_description():
    ...
    pkg_urdf_path = FindPackageShare('hexapod_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_urdf_path, 'rviz', 'hexapod_description.rviz'])
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'hexapod_description',
            'urdf_package_path': PathJoinSubstitution(['urdf','hexapod', LaunchConfiguration('model')]),
