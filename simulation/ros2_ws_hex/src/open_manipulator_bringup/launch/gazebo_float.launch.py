...
def get_robot_model():
    ...
    if robot_model not in ["om_x"]:  # Usunąłem "om_y", "om_y_follower" ponieważ używasz tylko om_x
...
def generate_launch_description():
    ...
    urdf_file = "open_manipulator_x_float"
    urdf_folder = "om_x"
    ...
    # Usunąłem load_gripper_controller, ponieważ nasz model nie ma chwytaka
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
               ...
               on_exit=[load_arm_controller],  # Usunąłem load_gripper_controller
            )
        ),
        bridge,
        ...
        gz_spawn_entity,
        #rviz,  # Odkomentowałem rviz, aby było widoczne w symulacji
    ])